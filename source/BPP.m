function BPPresult=BPP(items,box)%items is the sequence of sorting
H=box(1);
W=box(2);
D=box(3);
boxnum=0;
...
B=Vitems/(H*W*D*boxnum);
BPPresult={B,boxnum,fang};
end